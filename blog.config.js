...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'newboxlink', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || 'newboxlink|科学上网-vps评测-机场推荐-加密货币', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://yushop.eu.org/', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Notion, 科学上网，加密货币，机场，VPS', // 网站关键词 英文逗号隔开
